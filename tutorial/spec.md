...
For this project, the code layer in this repo owns `build_prism_dimensions`, `face_display_size`, and `build_prism_net_layout`, and adapter layer must not reimplement them.
